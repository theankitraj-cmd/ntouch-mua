        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <ScrollReveal>
            <div className="relative">
              <figure className="aspect-[3/4] rounded-2xl overflow-hidden bg-blush-100 relative shadow-xl m-0 p-0">
                <img 
                  src="/nancy-mehta-makeup-artist-patna-bihar.jpg"
                  alt="Who is Nancy Mehta? - Best Bridal Makeup Artist in Patna Bihar" 
                  title="Nancy Mehta"
                  className="absolute inset-0 w-full h-full object-cover"
                />
                <figcaption className="sr-only">Who is Nancy Mehta? Nancy Mehta is a Lakme Academy Certified Professional Bridal Makeup Artist and Skincare Specialist based in Patna, Bihar.</figcaption>
          ...
          <div>
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-light text-plum leading-tight mb-6">
                The Art of Transformation in Patna
                About{" "}
            ...
            <ScrollReveal delay={0.2}>
              <p className="font-body text-base md:text-lg text-plum-soft leading-relaxed mb-6">
                <strong className="text-plum font-semibold italic">Makeover By Nancy</strong> is led by Nancy Mehta, a certified Makeup Artist and Skincare Specialist with over 2 years of professional expertise. Trained at the world-renowned <strong className="text-plum font-semibold">Lakme Academy</strong>, Nancy specializes in the art of creating 3D bridal looks, HD bases, and luxurious airbrush transformations that last long after the party ends.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.25}>
              <p className="font-body text-base md:text-lg text-plum-soft leading-relaxed mb-6">
                With a passion for natural-yet-elevated glam, she has already transformed over <strong className="text-plum font-semibold underline decoration-blush-300">100+ happy brides</strong> and clients across Patna, Gaya, and Muzaffarpur. Her career reached a global peak supporting backstage at <strong className="text-plum font-semibold">Miss Universe 2025</strong> and <strong className="text-plum font-semibold">The Cover Girl Event</strong>, where she delivered camera-perfect artistry under immense pressure.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.3}>
              <p className="font-body text-base md:text-lg text-plum-soft leading-relaxed mb-8">
                Every face is a unique canvas, and Nancy's approach blends technical precision with a visionary eye for detail—ensuring your transformation is not just a makeup session, but a royal experience that radiates absolute confidence and timeless style.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.4}>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Sparkles, text: "3D Bridal Artistry" },
                  { icon: Heart, text: "HD & Airbrush Specialist" },
                  { icon: Star, text: "100+ Happy Brides" },
                  { icon: Award, text: "Lakme Certified Expert" },
                ].map((item, i) => (
                  <div
                    key={i}
...
function Portfolio() {
  ...
  return (
    <section id="portfolio" className="relative py-section overflow-hidden bg-surface-elevated transition-colors duration-700">
      ...
      {/* Direct Portfolio Links for SEO & UX */}
      <div className="mt-16 mb-8 text-center px-4 relative z-10 w-full">
        <ScrollReveal>
          <p className={`font-body text-sm tracking-[0.2em] uppercase mb-6 transition-colors duration-500 ${hoveredImage ? 'text-white/60' : 'text-plum/60'}`}>
            Explore Complete Subject Galleries
          </p>
        </ScrollReveal>
        <ScrollReveal delay={0.2}>
          <div className="flex flex-wrap items-center justify-center gap-4 max-w-4xl mx-auto">
            <Link href="/portfolio/bridal-makeup" className={`px-8 py-4 rounded-full border text-sm md:text-base font-medium transition-all duration-300 hover:scale-105 ${hoveredImage ? 'border-white/20 text-white hover:bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'border-plum/20 text-plum hover:bg-plum/5 hover:shadow-[0_0_15px_rgba(78,11,47,0.1)]'}`}>
              Bridal Artistry
            </Link>
            <Link href="/portfolio/party-makeup" className={`px-8 py-4 rounded-full border text-sm md:text-base font-medium transition-all duration-300 hover:scale-105 ${hoveredImage ? 'border-white/20 text-white hover:bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'border-plum/20 text-plum hover:bg-plum/5 hover:shadow-[0_0_15px_rgba(78,11,47,0.1)]'}`}>
              Party Glamour
            </Link>
            <Link href="/portfolio/engagement-makeup" className={`px-8 py-4 rounded-full border text-sm md:text-base font-medium transition-all duration-300 hover:scale-105 ${hoveredImage ? 'border-white/20 text-white hover:bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'border-plum/20 text-plum hover:bg-plum/5 hover:shadow-[0_0_15px_rgba(78,11,47,0.1)]'}`}>
              Engagement
            </Link>
            <Link href="/portfolio/hd-airbrush-makeup" className={`px-8 py-4 rounded-full border text-sm md:text-base font-medium transition-all duration-300 hover:scale-105 ${hoveredImage ? 'border-white/20 text-white hover:bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'border-plum/20 text-plum hover:bg-plum/5 hover:shadow-[0_0_15px_rgba(78,11,47,0.1)]'}`}>
              HD & Airbrush
            </Link>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.4}>
          <div className="mt-12 flex justify-center">
            <a 
              ...
              className="flex items-center gap-3 px-8 py-4 rounded-full border border-gold-400 text-gold-400 hover:bg-gold-400/10 transition-all group scale-105"
            >
              <Star className="w-5 h-5 text-gold-400 fill-gold-400" />
              <span className="font-body font-medium">Loved our service? Leave a Review</span>
  ...
  const faqs = [
    {
      ...
      a: "Nancy Mehta (Makeover By Nancy) is one of the top-rated makeup artists in Patna, Bihar. She is Lakme Academy certified and has worked at prestigious events like Miss Universe 2025 and The Cover Girl Event. She specializes in bridal, party, HD, and airbrush makeup.",
    },
    {
      q: "How much does bridal makeup cost in Patna?",
      a: "Bridal makeup pricing depends on the package you choose. Makeover By Nancy offers premium packages including HD/Airbrush base, 3D eye makeup, hairstyling, saree draping, and skin prep. Contact Nancy at +91 89691 84453 or WhatsApp for a personalized quote.",
    },
    {
    ...
    },
    {
      ...
      a: "Makeover By Nancy offers bridal makeup, party & reception glam, HD & airbrush makeup, editorial & photoshoot makeup, engagement makeup, skincare & facials, nail care, saree draping, and complete traditional styling.",
    },
    {
  ...
  return (
    <footer className="relative bg-blush-950 overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-12 items-start">
          ...
          <div>
            ...
            <p className="font-body text-sm text-white/50 leading-relaxed max-w-xs">
              ...
              Transforming faces, elevating confidence — Makeover By Nancy.
            </p>
          </div>
      ...
      <section className="sr-only">
        <h2>Best Bridal Makeup Artist in Patna - Nancy Mehta — Makeover By Nancy</h2>
        ...
        <p>Nancy Mehta (Makeover By Nancy) is a <strong>Lakme Academy certified professional</strong> specializing in <strong>bridal makeup in Patna, Bihar</strong>. 
